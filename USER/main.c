...
//				LED0=!LED0;//LED闪烁
//			}
		omega=((double)gyrox+26.00)/16.4;
		
		if((roll<(balence-range1))||(roll>(balence+range1)))
		{
			 right_speed(300);
			 left_speed(300);
		}
//		else if((roll>(balence-range1))&&(roll<(balence-range2)))
//		{
//			left_back();
//			right_back();
//			right_speed(0);
//			left_speed(0);	
//		}
     else if((roll>(balence-range2))&&(roll<balence))
		 {
			pwm=Kp*(balence-roll)-Kd*omega;
			if(pwm<0)
			{
				pwm=0;
			}
...
//		 else if((roll>(balence+range2))&&(roll<balence-range1))
//		 {
//			left_head();
//			right_head();
//			right_speed(0);
...
//			 left_speed(300);
//		}
//		else if((roll<balence)&&(roll>(balence-range1)))
//		{
//			left_back();
//			right_back();
//			right_speed(0);
